...
<body>
  <div class="container">
	<%@include file="/commons/header.jsp" %>
     <div id="statbox" class="ht_con clearfix" style="min-height: 700px;">
          <a href="${basePath}/admin/stat/edit">添加统计管理</a>
...
<script type="text/javascript" src="${basePath}/js/admin/stat/lt_stat.js"></script>
</body>
</html>