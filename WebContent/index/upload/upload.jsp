...
<html>
  ...
  <body>
  <input type="file" name="file"  multiple="multiple" accept="image/*" style="height:60px;display: block;">
  	<form action="server/uploadAction.jsp?dirpath=xiaojie" method="post" enctype="multipart/form-data">
  		<a href="javascript:void(0);" class="uploadbtn" onclick="openFileDialog()">文件上传</a>
  		<input type="file" name="doc" multiple="multiple" accept="image/*" id="file" onchange="uploadFile()" style="display: none;"/>
  	</form>
...
// 			}
			...
			//请求服务器
			xhr.open("post","server/uploadAction.jsp?dirpath=img",true);
			//请求成功的回调函数
