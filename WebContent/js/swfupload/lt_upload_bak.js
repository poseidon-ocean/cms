...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('g 6;a(t 6==="9"){6.7={};6.14.1A=9(1e){e 9(U){a(t 1e==="9"){1e.w(3,U)}3.1h=9(V,1x){3.j[V]=U[V]==28?1x:U[V]};3.p={};3.c={};3.1h("1J","10");3.c.1l=3.j.1y;3.c.1i=3.j.1w;3.c.18=3.j.1v;3.c.15=3.j.1s;3.c.X=3.j.1t;3.c.12=3.j.1u;3.c.13=3.j.1z;3.j.1y=6.7.1G;3.j.1w=6.7.1H;3.j.1v=6.7.1F;3.j.1s=6.7.1E;3.j.1t=6.7.1B;3.j.1u=6.7.1C;3.j.1z=6.7.1I;1O 3.1h}}(6.14.1A);6.7.1G=9(4){a(t 3.c.1l==="9"){4=6.7.v(4);e 3.c.1l.w(3,4)}};6.7.1H=9(4,Q,N){a(t 3.c.1i==="9"){4=6.7.v(4);e 3.c.1i.w(3,4,Q,N)}};6.7.1F=9(4){a(t 3.c.18==="9"){4=6.7.v(4,3.p);e 3.c.18.w(3,4)}};6.7.1E=9(4,Q,N){4=6.7.v(4,3.p);6.7.Y(4,3.p);a(t 3.c.15==="9"){e 3.c.15.w(3,4,Q,N)}};6.7.1B=9(4,Z,1r){3.1p(4,Z);4=6.7.v(4,3.p);a(t 3.c.X==="9"){e 3.c.X.w(3,4,Z,1r)}};6.7.1C=9(4,1D){a(t 3.c.12==="9"){4=6.7.v(4,3.p);e 3.c.12.w(3,4,1D)}};6.7.1I=9(4){4=6.7.v(4,3.p);6.7.Y(4,3.p);a(t 3.c.13==="9"){e 3.c.13.w(3,4)}};6.7.v=9(4,C){g 5;a(!4){e 4}a(C){5=C[4.L]}a(5){4.B=5.B;4.F=5.F;4.A=5.A;4.H=5.H;4.I=5.I;4.K=5.K;4.1o=5.f}z{4.B=0;4.F=0;4.A=0;4.H=0;4.I=0;4.K=0;4.1o=0}e 4};6.14.1p=9(4,f){g 5=3.p[4.L];a(!5){3.p[4.L]=5={}}f=f||5.f||0;a(f<0){f=0}a(f>4.k){f=4.k}g 1q=1j 1k().1g();a(!5.y){5.y=1j 1k().1g();5.G=5.y;5.B=0;5.F=0;5.A=0;5.E=[];5.H=0;5.I=0;5.K=f/4.k;5.f=f}z a(5.y>1q){3.21("2m 2l 2k 2g")}z{g J=1j 1k().1g();g G=5.G;g 19=J-G;g 1b=f-5.f;a(1b===0||19===0){e 5}5.G=J;5.f=f;5.B=1b*8/(19/1m);5.F=5.f*8/((J-5.y)/1m);5.E.1W(5.B);a(5.E.o>3.j.1J){5.E.26()}5.A=6.7.1X(5.E);5.H=(4.k-5.f)*8/5.A;5.I=(J-5.y)/1m;5.K=5.f/4.k*2s}e 5};6.7.Y=9(4,C){2i{C[4.L]=2j;1O C[4.L]}2h(2n){}};6.7.O=9(l,r,q,1K){g i,n,P,D;a(l===0){e"0 "+q[q.o-1]}a(1K){n=l;D=q.o>=r.o?q[r.o-1]:"";x(i=0;i<r.o;i++){a(l>=r[i]){n=(l/r[i]).1n(2);D=q.o>=i?" "+q[i]:"";2t}}e n+D}z{g 11=[];g R=l;x(i=0;i<r.o;i++){P=r[i];D=q.o>i?" "+q[i]:"";n=R/P;a(i<r.o-1){n=1d.2q(n)}z{n=n.1n(2)}a(n>0){R=R%P;11.1W(n+D)}}e 11.2d(" ")}};6.7.22=9(l){g 1L=[1T,1S,1R,1],1P=["23","2e","20","b"];e 6.7.O(l,1L,1P,1V)};6.7.1Z=9(l){g 1Q=[24,25,2b,1],1U=["d","h","m","s"];e 6.7.O(l,1Q,1U,2c)};6.7.2a=9(l){g 1M=[1T,1S,1R,1],1N=["27","2f","2p","2r"];e 6.7.O(l,1M,1N,1V)};6.7.1Y=9(l){e l.1n(2)+"%"};6.7.1X=9(M){g u=[],k,1a=0,T=0,1c=0,17=0,1f=0;g i;g S=0,W=0;k=M.o;a(k>=8){x(i=0;i<k;i++){u[i]=M[i];1a+=u[i]}T=1a/k;x(i=0;i<k;i++){1c+=1d.29(u[i]-T,2)}17=1c/k;1f=1d.2o(17);x(i=0;i<k;i++){u[i]=(u[i]-T)/1f}g 16=2;x(i=0;i<k;i++){a(u[i]<=16&&u[i]>=-16){W++;S+=M[i]}}}z{W=k;x(i=0;i<k;i++){S+=M[i]}}e S/W}}',62,154,'|||this|file|tracking|SWFUpload|speed||function|if||speedSettings||return|bytesUploaded|var|||settings|size|baseNumber||unit|length|fileSpeedStats|unitLabels|unitDivisors||typeof|vals|extendFile|call|for|startTime|else|movingAverageSpeed|currentSpeed|trackingList|unitLabel|movingAverageHistory|averageSpeed|lastTime|timeRemaining|timeElapsed|now|percentUploaded|id|history|message|formatUnits|unitDivisor|errorCode|remainder|mSum|mean|userSettings|settingName|mCount|user_upload_progress_handler|removeTracking|bytesComplete||formattedStrings|user_upload_success_handler|user_upload_complete_handler|prototype|user_upload_error_handler|deviationRange|variance|user_upload_start_handler|deltaTime|sum|deltaBytes|varianceTemp|Math|oldInitSettings|standardDev|getTime|ensureDefault|user_file_queue_error_handler|new|Date|user_file_queued_handler|1e3|toFixed|sizeUploaded|updateTracking|tickTime|bytesTotal|upload_error_handler|upload_progress_handler|upload_success_handler|upload_start_handler|file_queue_error_handler|defaultValue|file_queued_handler|upload_complete_handler|initSettings|uploadProgressHandler|uploadSuccessHandler|serverData|uploadErrorHandler|uploadStartHandler|fileQueuedHandler|fileQueueErrorHandler|uploadCompleteHandler|moving_average_history_size|singleFractional|bpsUnits|sizeUnits|sizeUnitLabels|delete|bpsUnitLabels|timeUnits|1024|1048576|1073741824|timeUnitLabels|true|push|calculateMovingAverage|formatPercent|formatTime|Kb|debug|formatBPS|Gbps|86400|3600|shift|GB|undefined|pow|formatBytes|60|false|join|Mb|MB|time|catch|try|null|in|backwards|When|ex|sqrt|KB|floor|bytes|100|break'.split('|'),0,{}))
/**
 * 封装swfupload文件上传组件
 * options:是参数
 * 为什么要封装
...
$.tzUpload = function(options){
	...
	var settings = {
		...
		post_params:{"result":"一个文件上传携带的参数"},//给后台传递的参数
...
$.tzUpload.defaults = {
	...
	single:false,
	htmlbox:"",
	img:basePath+"/js/swfupload/imagebtn.png",
	reload:function(){
	...
	fileQueue:function(file,opts){//上传队列的回调方法
		//把所有的文件全部放入到div中进行显示,定义你皮肤的展示形式
		$("#uploadbox").addClass("uploadbox").html("<h1 class='header'>"+
		"			<span id='uploadId'></span>"+
		"			<span class='fnum'>文件个数：<label class='rnum' id='queueNum'>0</label>个</span>"+
		"			<span class='fnum'>平均速率：<label class='rnum' id='uploadBit'>0</label>/S</span>"+
		"			<span class='fnum'>剩余时间：<label class='rnum' id='uploadTime'>0</label></span>"+
		"			<span class='fnum'>上传了：<label class='rnum' id='uploadOverTime'>00:00</label></span>"+
		"		</h1>"+
		"		<div>"+
		"			<div class='uploadProgress'>"+
		"				<div class='uploadPercent' id='uploadPercent'></div>"+
		"				<div>"+
		"					<span class='rname'><label id='uploadFileName'></label></span>"+
		"					<span class='percentnum' id='uploadLoadNum'></span>"+
		"				</div>"+
		"			</div>"+
		"		</div>"+
		"		<div>"+
		...
		"		</div>" +
		"		<div id='fileList'></div>");
		$.tzUpload.defaults.htmlbox +="<p id='"+file.id+"'>"+file.name+"<a href='javascript:void(0);' onclick=tzUpload.cancleUpload('"+file.id+"')>取消上传</a>" +
		"&nbsp;&nbsp;<a href='javascript:void(0);' onclick=tzUpload.start('"+file.id+"')>开始上传</a>" +
		"&nbsp;&nbsp;<a href='javascript:void(0);' onclick=tzUpload.cstop()>暂停</a></p>";
		document.getElementById("fileList").innerHTML = $.tzUpload.defaults.htmlbox;
	...
	uploadStart:function(file){
		...
		this.customSettings.uploadFileNameDom.innerHTML = "正在上传："+file.name;
		$.tzUpload.defaults.updateDisplay.call(this, file);
	},
	...
	updateDisplay:function(file) {
		 //上传了多少
		 this.customSettings.uploadLoadedDom.innerHTML=SWFUpload.speed.formatBytes(file.sizeUploaded);
		 //上传文件的总大小
		 ...
		 //控制进度条的走向
	 	 this.customSettings.uploadPercentDom.style.width =  SWFUpload.speed.formatPercent(file.percentUploaded);
	 	 //上传百度比的数字的展示和走动
	 	 this.customSettings.uploadLoadNumDom.style.left =  SWFUpload.speed.formatPercent(file.percentUploaded-11);
	 	 this.customSettings.uploadLoadNumDom.innerHTML = SWFUpload.speed.formatPercent(file.percentUploaded);
	 	 //当前速度
	...
	uploadError:function(file, errorCode, message) {
	 ...
	 uploadShowError:function(id,message){
		 $("#"+id).show().html(message).stop(true).fadeOut(4000);
	 }
};
