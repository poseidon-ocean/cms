...
function updateDisplay(file) {
	...
	this.customSettings.tdSizeCount.innerHTML = SWFUpload.speed.formatBytes(file.size);
	this.customSettings.tdSizeUploaded.innerHTML = SWFUpload.speed.formatBytes(file.sizeUploaded);
	this.customSettings.tdSizeRemaining.innerHTML = SWFUpload.speed.formatBytes(file.size-file.sizeUploaded);
...
function fileQueueError(file, errorCode, message) {
	try {
		...
		case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
			this.customSettings.tdErrors.innerHTML = "File is too big.";
